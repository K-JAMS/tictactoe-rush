...
export const HowToPlay = ({ setHtp, playClickSound, isMuted}) => {
  ...
  const rush = (
    <>
      ...
      <p className="text-black text-xs text-md:text-sm lg:text-md xl:text-[15px] text-shadow-lg pb-3">
      ...
      <p className="text-black text-xs text-md:text-sm lg:text-md xl:text-[15px] text-shadow-lg pb-2">
