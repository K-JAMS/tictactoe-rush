        ...
        {!start && !showGame && !twoPlayer && (
          <>
            <button
              ...
              className="absolute top-5 right-7 text-white text-4xl md:text-5xl px-2 text-stroke-black hover:text-gray-400 transition duration-300 cursor-pointer"
            >
              {isMuted ? (
            ...
            <div className="flex items-center justify-center z-30 pt-10">
              <img
                src={TTTRLogo}
                className=" max-w-[400px] min-w-[100px] pointer-events-non"
              />
            </div>
